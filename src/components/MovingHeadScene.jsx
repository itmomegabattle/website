...
export default function MovingHeadScene({ onReady }) {
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      model.scale.setScalar((isCompactViewport ? 0.41 : 1.18) / maxDimension);
      model.position.y = isCompactViewport ? -0.36 : -0.52;
      ...
      floorShadow.position.set(0, isCompactViewport ? -0.55 : -0.94, 0.03);
      ...
      const render = (now) => {
        ...
        model.position.y = (isCompactViewport ? -0.36 : -0.52) + idleFloat;
